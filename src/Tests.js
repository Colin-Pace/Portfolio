...
function Tests() {
  return (
    <div id = "testSection">
      ...
      <p>Throughout my early and young adult life, I placed well on standardized tests. Here are six tests in which I placed in the 95th percentile or higher, with a few placements in the 1st percentile. The format of the list is the test name, my percentile rankings on them, and my age during the test.
        <ol>
          ...
          <li><a href = "#testFiveTitle">The Texas Assessment of Academic Skills, 99th* (reading) and 98th* (mathematics) percentiles, age 14</a></li>
      ...
      <p>My first achievement, I placed in the 98th percentile on the Stanford Test at age 5. With more than 205 questions, the Stanford Test assessed reading, mathematics, and some other topics.</p>
      <img 
        id = 'stanfordTest' 
        className = '' 
      ...
      <p>The following year, at age 6, I took the Metropolitan Test. I did less well on the Metropolitan Test than I did on the Stanford Test, but I still did well on the Metrpolitan Test. I am proud of this ranking.</p>
      <img 
        id = 'risdTest' 
        className = '' 
      ...
      <h2 id = "testFiveTitle">The Texas (TAAS) Test 2001</h2>
        <p>ChatGPT thinks I did equally well in reading on the second TAAS test by percentile if not score. The mathematics percentile is also good.</p>
        <img 
          id = 'taasTwo' 
          className = '' 
