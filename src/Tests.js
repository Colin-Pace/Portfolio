    ...
    <div id = "testSection">
      ...
      Key: * denotes ChatGPT's estimation percentile based on the test result form, and + denotes a likely higher percentile by age range.
        ...
        <h2 id = "testSevenTitle">Lexiq 2024</h2>
          ...
          <p>In 2024, I took my first IQ test. Lexiq is a high-range IQ test, which I took because of my previous multiple placements in the top first percentile on achievement tests. Lexiq tests verbal intelligence. I did well on Lexiq. According to the World Genius Directory, the rarity of an IQ 172 is 1 in 1 million. For those interested in IQ tests, the general intelligence factor (G) loading correlation with Lexiq is <a href = "https://iq-tests-for-the-high-range.com/statistics/others/soulios.html" target = "_blank">approximately .74</a>.</p>
          <img 
            id = 'lexiq' 
            className = '' 
