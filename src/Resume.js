      ...
      <div id = 'resumeContainer'>
        <div id = 'resumeLeft'>
          <div className = 'edStint'>
            ...
            <p className = 'school'>The Coding Boot Camp at The University of Texas, Austin</p>
          ...
          <div className = 'edStint'>
            ...
            <p className = 'moreInfo'>- Courses in for the MA/PhD program</p>
            <p className = 'moreInfo'>- Funded by The National Science Foundation</p>
          </div>

          <div className = 'edStint'>
            <p className = 'school'>The University of Texas, Austin -- Master's</p>
          ...
          <div className = 'edStint'>
            <p className = 'school'>The University of Texas, Austin -- Bacherlor of Arts</p>
