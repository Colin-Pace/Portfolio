    ...
    <div>
      ...
      <p className = "profileItem">Milestones: 
        <ul>
          ...
          <li className = 'stemItem'>My <a className = 'milestone' id = 'mediumLink' href = "https://medium.com/@colinpace1987" target="_blank">Medium articles</a> about the natural sciences</li>
