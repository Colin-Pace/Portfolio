...
function Profile() { 
  return ( 
    <div>
      ...
      <p className = 'profileText'>The connection between my graduate work at UT Austin and web development is the study of language, of syntax and vocabulary, in the composition of text. After I mastered the basics of JavaScript, I wrote a book, <i>Algorithms and Programs: An Introduction with JavaScript</i>, that first explains the syntax of JavaScript for beginners and then introduces the reader to data structures and algorithms. The book also serves as an introduction to the more advanced book <i>Cracking the Coding Interview</i>.</p>
