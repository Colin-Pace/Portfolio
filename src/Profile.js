...
function Profile() { 
  return ( 
    <div> 
      ...
      <p className = 'profileText'>Please explore my profile. The tests section contains my placements on the high end of the spectrum for an IQ, an aptitude, and some achievement tests. The code section has my coding projects. The CV section has my resume. The blog and YouTube links take you to my science blog on Medium and my YouTube channel.</p>
